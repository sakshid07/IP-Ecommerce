...
$get_product = get_product($dbconnect,$id);
        ...
        <div class="row1">
            ...
            <p><b>Description:</b><br>This age-old practice has gone in and out of popularity for thousands of years. You can find a variety of beautiful and elegant macrame art on our website.</p>    
            <br>
            <form method="post"> 
            <button  type="submit" name="button1" style="background-color:#d81b60;height:50px;width:150px;border-radius:4%;border:none;color:white"><b><i style="font-size:20px;margin-right:3px;" class="fa fa-shopping-cart"></i> Add to Bag</b></button>
            </form>
